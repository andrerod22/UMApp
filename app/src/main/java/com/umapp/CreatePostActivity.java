        ...
        uploadButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(title)){
                    Toast.makeText(CreatePostActivity.this, "Title required.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(description)){
                    Toast.makeText(CreatePostActivity.this, "Description required.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (image_rui == null){
                    // post without image
            ...
            ref.child(timeStamp).setValue(hashMap)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void v){
                            progressBar.dismiss();
                            Toast.makeText(CreatePostActivity.this, "Post successfully added!", Toast.LENGTH_SHORT).show();
                            //reset views
                            titleEt.setText("");
